...
namespace Game
{
    public partial class frmComida : Form
    {
        ...
        public void IniciarJuego()
        {
            ...
            picComida.Image = null;
            lblTulomataste.Visible = false;
            Oportunidades = 0;
            Palabras = new string[] { "pupusa", "mariscada", "carne", "pollo", "riguas", "macarron", "arepa", "hamburguesa", "torta", "papas fritas", "tacos", "enchiladas", "pancake", "cereal", "avena", "costilla", "sopa" };
            ...
            foreach (char LetraAlfabeto in Alfabeto)
            {
                ...
                btnLetra.BackColor = Color.FromArgb(221, 221, 221);
            ...
            for (int IndiceValorLetra = 0; IndiceValorLetra < PalabraSeleccionada.Length; IndiceValorLetra++)
            {
                ...
                Letra.BackColor = Color.FromArgb(221, 221, 221); 
        ...
        void Compara(object sender, EventArgs e)
        {
            ...
            if (!encontrado)
            {
                ...
                picComida.Image = (Bitmap)Properties.Resources.ResourceManager.GetObject("Comida" + Oportunidades);
        ...
        private void lblTulomataste_Click(object sender, EventArgs e)
        {
